...
+---------------------------------+----------------------------+
| **Student ID Numbers and Names  | 1.  134644 - C - Sebastian |
| of Group Members**              |     Muramara               |
|                                 |                            |
|                                 | 2.  136675 - C - Bernard   |
|                                 |     Otieno                 |
|                                 |                            |
...
An item frequency plot is created to visualize the occurrence of the top 10 individual items.
